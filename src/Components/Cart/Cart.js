...
const Cart = (props) => {
    ...
    return (
        <div className="cart-table table-responsive-sm">
            <table className="table table-hover table-bordered">
                <thead>
                    <tr>
                        <th scope="col"></th>
                        {browserWidth>400? <th scope="col">ITEM</th> : ""}
                ...
                <tbody>
                    ...
                    <tr>
                    {browserWidth>400? <th className="text-center align-middle" rowSpan="6" colSpan="4" scope="col">Coupon: <input type="text" /> <button className="btn btn-discount">APPLY</button></th> : <th className="text-center align-middle" rowSpan="6" colSpan="3" scope="col">Coupon: <input type="text" /> <button className="btn btn-discount">APPLY</button></th>}
